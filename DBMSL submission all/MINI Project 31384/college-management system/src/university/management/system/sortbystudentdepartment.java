...
public class sortbystudentdepartment extends JFrame implements ActionListener{
    ...
    int i=0, j=0;
   public  sortbystudentdepartment(){
        ...
        try{
            conn c1  = new conn();
            String s1 = "select * from student order by course;";
